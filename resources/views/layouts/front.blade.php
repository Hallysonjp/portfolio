...
<body class="common-front @if ($currentLang->rtl == 1) rtl @endif"
    ...
    @if ($setting->maintenance_status == 1)
        <div class="maintenance_cls">
            <div class="maintenance_inner">{!! $setting->maintenance_text !!}</div>
        </div>
    @endif
    ...
    @if ($setting->maintenance_status == 0)
                    ...
                    @if ($headerfooter->sidebar_title2)
                        <div class="header__action">
                            <a class="header__action-btn header__action-btn--start-project"
                                href="{{ $headerfooter->sidebar_description2 }}">
                                {{ $headerfooter->sidebar_title2 }} <svg width="11.4" height="9.2">
                    ...
                    @if ($headerfooter->sidebar_title)
                        <div class="header__action">
                            <a class="header__action-btn header__action-btn--start-project"
                                ...
                                {{ $headerfooter->sidebar_title }} <svg width="11.4" height="9.2">
                                    <use xlink:href="#arrow"></use>
                                </svg>
                            </a>
                        </div>
                        ...
                        @if (!empty($currentLang) && count($langs) > 1)
                            ...
                            <ul class="header__lang-list">
                                ...
                                @foreach ($langs as $key => $lang)
                                    <li @if ($currentLang->code == $lang->code) class="active" @endif><a
                                            title="{{ $lang->name }}"
                                            href='{{ route('changeLanguage', $lang->code) }}'><span>{{ $lang->code }}</span></a>
                                    </li>
                                @endforeach
                            </ul>
                        @endif
                    ...
                    <div class="left-side">
                        ...
                        <div class="left-side-inner">
                            ...
                            <div class="header__menu__venor">
                                <ul class="header__nav">
                                    ...
                                    @foreach ($menus->sortBy('order') as $prod)
                                        ...
                                        @else
                                            <li class="header__nav-item"> <a title="{{ $prod->name }}"
                            ...
                            <div class="address-sidebar">
                                <div><img width="16" height="16" src="/img/map-pin.svg" alt="map-pin.svg">
                                    {!! $setting->address !!}</div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{ $headerfooter->typed_buttonlink }}" target="_self"
                            class="btn btn-style1"><span>{{ $headerfooter->typed_buttontext }}</span><svg
                        ...
                        <div class="footer-left">
                            <div class="inner">
                                ...
                                <a class="btn btn-style2" href="{{ $headerfooter->footer_col1_buttonlink }}">
                                    <span>{{ $headerfooter->footer_col1_buttontext }}</span> <svg width="11.4"
                                        height="9.2">
                                        <use xlink:href="#arrow"></use>
                                    </svg></a>
                            </div>
        ...
        @if ($setting->whatsapp == 1)
            <a class="chat__trigger-quin logo-chat" href="https://wa.me/{{ $setting->phone }}" target="_blank"
                title="whatsapp">
        ...
        <svg width="0" height="0" display="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <symbol id="chat" xmlns="http://www.w3.org/2000/svg" width="30.2" height="30.2" viewBox="0 0 30.2 30.2"
